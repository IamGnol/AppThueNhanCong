...
public class AdapterBangGiaSuaNha extends FirebaseRecyclerAdapter<DichVu, AdapterBangGiaSuaNha.myViewHolder> {
     ...
     * @param options
     */
    public AdapterBangGiaSuaNha(@NonNull FirebaseRecyclerOptions<DichVu> options) {
        super(options);
    }
