...
public class ChiTietHoaDonNhanVien extends AppCompatActivity {
    ImageView trove;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chi_tiet_hoa_don_nhan_vien);
        ...
        trove.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(ChiTietHoaDonNhanVien.this, DanhSachHoaDonNhanVien.class));
                finish();
            }
        });
    }
