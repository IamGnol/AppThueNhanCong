    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.child("dichvu").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                ArrayAdapter<String> arrayAdapter=new ArrayAdapter<>(DangKiNhanVien.this, R.layout.mauspinnerlayout,tendv);
                arrayAdapter.setDropDownViewResource(R.layout.mauthaxuongspinner);
                congviec.setAdapter(arrayAdapter);
            }
        ...
        dangky.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(hotenedit.getText().toString().isEmpty() || passedit.getText().toString().isEmpty() || phoneedit.getText().toString().isEmpty() || email.getText().toString().isEmpty() || repass.getText().toString().isEmpty()){
                    ...
                    Toast.makeText(DangKiNhanVien.this, "Email phải có @mail.com", Toast.LENGTH_SHORT).show();
