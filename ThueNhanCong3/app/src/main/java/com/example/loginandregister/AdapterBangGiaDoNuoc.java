...
public class AdapterBangGiaDoNuoc extends FirebaseRecyclerAdapter<DichVu, AdapterBangGiaDoNuoc.myViewHolder> {
     ...
     * @param options
     */
    public AdapterBangGiaDoNuoc(@NonNull FirebaseRecyclerOptions<DichVu> options) {
        super(options);
    }
