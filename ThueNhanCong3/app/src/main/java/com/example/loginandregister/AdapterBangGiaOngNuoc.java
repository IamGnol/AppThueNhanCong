...
public class AdapterBangGiaOngNuoc extends FirebaseRecyclerAdapter<DichVu, AdapterBangGiaOngNuoc.myViewHolder> {
     ...
     * @param options
     */
    public AdapterBangGiaOngNuoc(@NonNull FirebaseRecyclerOptions<DichVu> options) {
        super(options);
    }
