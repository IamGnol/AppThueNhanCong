...
public class AdapterBangGiaSuaDien extends FirebaseRecyclerAdapter<DichVu, AdapterBangGiaSuaDien.myViewHolder> {
     ...
     * @param options
     */
    public AdapterBangGiaSuaDien(@NonNull FirebaseRecyclerOptions<DichVu> options) {
        super(options);
    }
