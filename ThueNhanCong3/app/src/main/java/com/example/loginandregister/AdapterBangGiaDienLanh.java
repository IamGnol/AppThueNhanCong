...
public class AdapterBangGiaDienLanh extends FirebaseRecyclerAdapter<DichVu, AdapterBangGiaDienLanh.myViewHolder> {
     ...
     * @param options
     */
    public AdapterBangGiaDienLanh(@NonNull FirebaseRecyclerOptions<DichVu> options) {
        super(options);
    }
