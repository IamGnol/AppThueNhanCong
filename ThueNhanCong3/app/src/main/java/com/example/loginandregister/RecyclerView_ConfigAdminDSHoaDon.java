...
public class RecyclerView_ConfigAdminDSHoaDon {
    ...
    class LichDatItemView extends RecyclerView.ViewHolder {
        ...
        public LichDatItemView(ViewGroup parent) {
            ...
            dongia=itemView.findViewById(R.id.txtdongia);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(mcontext, ChiTietHoaDonAdmin.class);
                    ...
                    intent.putExtra("dongia", dongia.getText().toString());
...
//                    intent.putExtra("tenkhachhang",tenkhachhang.getText().toString());
        ...
        public void bind(HoaDon hoaDon,String key){
            ...
            dongia.setText(hoaDon.getDongia());
