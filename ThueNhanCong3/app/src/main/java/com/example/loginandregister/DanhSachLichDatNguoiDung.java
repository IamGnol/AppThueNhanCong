...
//        getListLichDatFromDatabase();
        new FirebaseDatabaseHelperNguoiDung().readDanhsach(new FirebaseDatabaseHelper.DataStatus() {
            @Override
            public void DataIsLoaded(List<LichDat> lichdat, List<String> keys) {
                new RecyclerView_ConfigNguoiDung().setConfig(recyclerviewLichDat, DanhSachLichDatNguoiDung.this,lichdat,keys);
            }
