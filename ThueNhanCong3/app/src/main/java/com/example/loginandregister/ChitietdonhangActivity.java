...
public class ChitietdonhangActivity extends AppCompatActivity {
    TextView txtdichvu,txtdiachi,txtnoidung,txtngaydat,txtsdt, txtemail,txtphanhoi;
 ...
 //   private String emailnv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        phanhoi=getIntent().getStringExtra("phanhoikh");
  //      emailnv = getIntent().getStringExtra("emailnv");
        ...
        txtemailnv.getSelectedItem().toString();
        txtemail = findViewById(R.id.email);
        txtemail.setText(email);
        txtphanhoi=findViewById(R.id.phanhoikhachang);
        txtphanhoi.setText(phanhoi);
        ...
        capnhat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(!txtemailnv.getSelectedItem().toString().contains("@gmail.com")){
                    Toast.makeText(ChitietdonhangActivity.this, "Hãy nhập đúng email", Toast.LENGTH_SHORT).show();
                }else{
                    mAuth.fetchSignInMethodsForEmail(txtemailnv.getSelectedItem().toString()).addOnCompleteListener(new OnCompleteListener<SignInMethodQueryResult>() {
                        @Override
                        public void onComplete(@NonNull Task<SignInMethodQueryResult> task) {
                            ...
                            if (check) {
                                ...
                                lichDat.setEmailnv(txtemailnv.getSelectedItem().toString());
